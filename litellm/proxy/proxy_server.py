...
class ProxyConfig:
    ...
    async def _delete_deployment(self, db_models: Sequence[LiteLLM_ProxyModelTable]) -> int:
        """
    ...
    async def _get_models_from_db(self, prisma_client: PrismaClient) -> Optional[Sequence[LiteLLM_ProxyModelTable]]:
        ...
        DB otherwise. Every write path invalidates the cache, so a miss here is what makes
        another pod's write visible.
        ...
        await set_cached_model_rows(models)
        return models
