...
class WebSearchInterceptionLogger(CustomLogger):
    ...
    def _sync_forced_tool_choice(
        cls, tool_choice: object, converted_tools: list[dict[str, object]]
    ) -> object:
    ...
    async def _execute_search(
        self, query: str, kwargs: Optional[Dict[str, object]] = None
    ...
    @staticmethod
    def _get_user_api_key_auth_from_kwargs(kwargs: Optional[Dict[str, object]]) -> Optional["UserAPIKeyAuth"]:
        if not kwargs:
            return None
